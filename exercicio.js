const itens = ExemplosdeComponentesFunconais . querySelectorAll ( '.item' ) ;
const ulItem  =  ExemplosdeComponentesFunconais . querySelector ( '.items' ) ;
const valores  = ExemplosdeComponentesFunconais . querySelectorAll ( '.valor' ) ;
const span  =  ExemplosdeComponentesFunconais . querySelectorAll ( 'span' ) ;
